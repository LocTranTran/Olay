...
export default function Footer() {
  return (
    ...
    <MDBFooter style={{ width: '90vw',fontSize:'1.5rem' }}
bgColor='dark' className='text-center text-lg-start text-muted'>
      <section className='d-flex justify-content-center justify-content-lg-between p-4 border-bottom'>
        ...
        <div>
          <a href='https://www.facebook.com/people/H%C3%A3ng-m%E1%BB%B9-ph%E1%BA%A9m-c%E1%BB%A7a-M%E1%BB%B9-Olayso/61550746753613/?mibextid=9R9pXO' className='me-4 text-reset'>
